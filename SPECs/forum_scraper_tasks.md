...
| HITO-06 | TASK-018 | IN_PROGRESS | Docker, Raspberry readiness y README | Agente unico | [TASK-018](task_specs/TASK-018_docker_raspberry.md) | TASK-024 | `Dockerfile`, `docker-compose.yml`, `README.md` | `feat: add portable docker deployment` |
| HITO-06 | TASK-019 | TODO | Hardening final y DoD v1 | Agente unico | [TASK-019](task_specs/TASK-019_final_acceptance.md) | TASK-001..TASK-018, TASK-020 | todo el proyecto | `test: complete v1 acceptance coverage` |
